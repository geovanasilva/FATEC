    ...
    if( request.getParameter("_method") != null )
    {
        ...
        switch( request.getParameter("_method").toString() )
        {
            case "insert" :
                ...
                Database.insert("pessoa", p);
                response.sendRedirect(request.getRequestURI());
                break;
            case "update" :
                String[] dados = new String[6];
                dados[0] = request.getParameter("nm_cliente_editar");
                dados[1] = request.getParameter("email_cliente_editar");
                dados[2] = request.getParameter("tel_cliente_editar");
                dados[3] = request.getParameter("endereco_cliente_editar");
                dados[4] = request.getParameter("cd_cliente_editar");
                dados[5] = request.getParameter("cd2_cliente_editar");
                Database.update("pessoa", dados, Integer.parseInt(request.getParameter("id_editar")));
                response.sendRedirect(request.getRequestURI());
                break;
            case "delete" :
                Database.delete("pessoa", Integer.parseInt(request.getParameter("id_delete")));
                response.sendRedirect(request.getRequestURI());
                break;
            default:
                break;
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="main-content col-md-10 col-md-offset-2 col-sm-8">
                ...
                <!-- BotÃ£o de inclusão de cadastro-->
                <div class="row">
                            ...
                            <div class="col-md-12">
                                <form role="form" action="#" data-name="form-add">
                                    ...
                                    <div class="form-group  has-feedback">
                                        ...
                                        <input type="text" name="cd_cliente_salvar" data-validate="cpf" id="cd_cliente_salvar" class="form-control add" placeholder="Digite o CPF do cliente" />
                                        <span class="" data-name="icon-error"></span>
                                    </div>
                                    <div class="form-group  has-feedback">
                                        <label for="cd2_cliente_salvar"><strong>RG do cliente</strong></label>
                                        <input type="text" name="cd2_cliente_salvar" data-validate="rg" id="cd2_cliente_salvar" class="form-control add" placeholder="Digite o RG do cliente" />
                                        <span class="" data-name="icon-error"></span>
                                    </div>
                                    <div class="form-group  has-feedback">
                                    ...
                                    <div class="form-group  has-feedback">
                                        ...
                                        <input type="text" name="tel_cliente_salvar" data-validate="phone" id="tel_cliente_salvar" class="form-control add" placeholder="Digite o telefone do cliente" />
                                        <span class="" data-name="icon-error"></span>
                                    </div>
                                    <div class="form-group  has-feedback">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-danger form-control" data-name="btn-adiciona-cliente" type="submit" >Salvar</button><!-- data-name="btn-adiciona-cliente" -->
                                    </div>
                                </form>
                            </div>
                        </div>  
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form role="form" action="#" data-name="form-edit">
                                    ...
                                    <div class="form-group  has-feedback">
                                        ...
                                        <input type="text" name="cd_cliente_editar" data-validate="cpf" id="cd_cliente_editar" class="form-control edit" placeholder="Digite o CPF do cliente" />
                                        <span class="" data-name="icon-error"></span>
                                    </div>
                                    <div class="form-group  has-feedback">
                                        <label for="cd2_cliente_editar"><strong>RG do cliente</strong></label>
                                        <input type="text" name="cd2_cliente_editar" data-validate="rg" id="cd2_cliente_editar" class="form-control edit" placeholder="Digite o RG do cliente" />
                                        <span class="" data-name="icon-error"></span>
                                    </div>
                                    <div class="form-group  has-feedback">
                                    ...
                                    <div class="form-group  has-feedback">
                                        ...
                                        <input type="text" name="tel_cliente_editar" data-validate="phone" id="tel_cliente_editar" class="form-control edit" placeholder="Digite o telefone do cliente" />
                                        <span class="" data-name="icon-error"></span>
                                    </div>
                                    <div class="form-group  has-feedback">
        ...
        <script>
            $(document).ready(function () {
                ...
                $("[data-validate='cpf']").mask("999.999.999-99",{placeholder:"xxx.xxx.xxx-xx"});
                $("[data-validate='rg']").mask("99.999.999-9",{placeholder:"xx.xxx.xxx-x"});
                ...
                $('[data-name="btn-adiciona-cliente"]').click(function (button) {
                    ...
                    if( verificaCpf($("#cd_cliente_salvar").val()) == false)
                    {
                        if( !$("#cd_cliente_salvar").hasClass("has-error") )
                        {
                           status = false;
                           $("#cd_cliente_salvar").parent().addClass("has-error");
                           $("#cd_cliente_salvar").next("span").addClass("glyphicon glyphicon-remove form-control-feedback");
                        }
                    }
                ...
                $('[data-name="btn-altera-cliente-send"]').click(function (button) {
                    ...
                    if( verificaCpf($("#cd_cliente_editar").val()) == false)
                    {
                        if( !$("#cd_cliente_editar").hasClass("has-error") )
                        {
                           status = false;
                           $("#cd_cliente_editar").parent().addClass("has-error");
                           $("#cd_cliente_editar").next("span").addClass("glyphicon glyphicon-remove form-control-feedback");
                        }
                    }
